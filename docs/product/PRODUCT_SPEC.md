...
- **A clinical or diagnostic product.** Contig is for research use only. No diagnostic claims, no clinical decision support, no patient-facing or regulated diagnostic interpretation. (This also shapes the MVP pipeline choice — §5.)
