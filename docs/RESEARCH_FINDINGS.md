...
- **Feasibility:** Achievable today. LLMs (GPT-4o, Gemini 2.5 Flash, DeepSeek-V3) already generate technically accurate, executable workflows from NL. A software founder can reach expert-level on the conceptual layer with small models (Phi-3) + RAG over docs, with no massive compute or credentials.
...
LLMs (GPT-4o, Gemini 2.5 Flash, DeepSeek-V3) generate technically accurate, executable Galaxy/Nextflow workflows from NL; a software founder can reach expert-level on the conceptual layer with small models (Phi-3) + RAG over docs, with no massive compute or credentials.
