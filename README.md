...
| Single-cell RNA-seq | [`nf-core/scrnaseq`](https://nf-co.re/scrnaseq) | estimated cells, median genes per cell, reads in cells | wired · QC pack |
| Germline variant calling (research) | [`nf-core/sarek`](https://nf-co.re/sarek) | Ti/Tv & het/hom ratios, variant count, coverage, sex check | wired · QC pack |
| Somatic variant calling (tumor–normal, research) | [`nf-core/sarek`](https://nf-co.re/sarek) | Strelka2-vs-Mutect2 concordance, VAF distribution, somatic variant count, panel-of-normals | wired · QC pack |
